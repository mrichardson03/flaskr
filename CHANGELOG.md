...
- **deps**: Update dependency uv to ~=0.11.3
  ([#207](https://github.com/mrichardson03/flaskr/pull/207),
  [`a04c061`](https://github.com/mrichardson03/flaskr/commit/a04c061211cf35d278366e654e5c7edb07f9b8d3))
...
- Update urllib3
  ([`0100324`](https://github.com/mrichardson03/flaskr/commit/01003248d9434fc7b218afc662aa6a07e2feb0cc))

- Update werkzeug to 3.1.5
  ([`892ed87`](https://github.com/mrichardson03/flaskr/commit/892ed878c9d1cbe56e6ac56e848ed21ca357126e))
...
- **deps**: Update dependency python-semantic-release to ~=10.5.2
  ([#193](https://github.com/mrichardson03/flaskr/pull/193),
  [`5298811`](https://github.com/mrichardson03/flaskr/commit/5298811819f45dda9dc95b9c516d409bd82aaab4))

- **deps**: Update dependency uv to ~=0.10.7
  ([#199](https://github.com/mrichardson03/flaskr/pull/199),
  [`c19383b`](https://github.com/mrichardson03/flaskr/commit/c19383ba3d9ae63820d7770a7d2ac12b65aff5f8))
...
- **deps**: Update dependency python-semantic-release to ~=10.4.1
  ([#183](https://github.com/mrichardson03/flaskr/pull/183),
  [`062be12`](https://github.com/mrichardson03/flaskr/commit/062be12d9bbef34f19492229377dbcabf14325a5))

- **deps**: Update dependency uv to ~=0.9.7
  ([#184](https://github.com/mrichardson03/flaskr/pull/184),
  [`60805c5`](https://github.com/mrichardson03/flaskr/commit/60805c5259aef38375dc201034b51e4cc9efeb93))

### Features

- Python 3.14 ([#190](https://github.com/mrichardson03/flaskr/pull/190),
  [`e43f0a5`](https://github.com/mrichardson03/flaskr/commit/e43f0a559ed609efa1649c737eca35827399f3a8))
...
- Add cryptography module
  ([`dc191dc`](https://github.com/mrichardson03/flaskr/commit/dc191dcf09ecd99d898c62c7672f2c21faffc8ee))
...
- Use multistage builds
  ([`e58159b`](https://github.com/mrichardson03/flaskr/commit/e58159b3e181f4bd7a97cfe6d3544e98f9a1392e))
...
- Add token to semantic-release
  ([`561d6f2`](https://github.com/mrichardson03/flaskr/commit/561d6f2e2ddf559707f6fee3447315bd8e5a70f3))

- Bump for uv release
  ([`202f996`](https://github.com/mrichardson03/flaskr/commit/202f996cb528ae27e5ee6de6c85459129e2aa8fa))

- Change token variable
  ([`4192aa2`](https://github.com/mrichardson03/flaskr/commit/4192aa2655c3754c1d94712136a8e66e1187addb))
